...
export function Pricing() {
  return (
    <div className="py-[48px] lg:py-[60px] bg-gradient-to-b from-white to-[#E3F1FF]">
      ...
      <div className="flex flex-col gap-y-6 gap-x-[24px] lg:flex-row">
        {/* Free Trial Plan */}
        <div className="w-full rounded-[8px] bg-[#F5F4FF] p-6 flex flex-col lg:justify-between transition-transform duration-300 hover:scale-105 hover:shadow-lg">
          <div>
          ...
          <button className="mt-[16px] rounded-[4px] bg-white py-[14px] text-[#4328EB] font-medium transition-transform duration-200 hover:scale-105">
            Start Trial
          </button>
        </div>

        {/* Business Plan */}
        <div className="w-full rounded-[8px] bg-[#4328EB] p-6 flex flex-col transition-transform duration-300 hover:scale-105 hover:shadow-lg">
          <div>
